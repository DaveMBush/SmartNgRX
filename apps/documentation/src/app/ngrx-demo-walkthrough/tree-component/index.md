...
You'll also note that the `transform()` method is [recursive](https://github.com/DaveMBush/SmartNgRX/blob/main/apps/demo-smart-ngrx/src/app/shared/components/tree/tree-component.service.ts#L89-L97) to access the child elements of a node.
