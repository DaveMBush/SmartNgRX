...
jest.mock('@smarttools/core/feature-registry.class');
jest.mock('@smarttools/core/registrations/entity-definition-registry.function');
jest.mock('@smarttools/core/registrations/entity-registry.class');
jest.mock('@smarttools/core/registrations/service-registry.class');
jest.mock('./signal-facade/entity-signal-store.factory');
jest.mock('@smarttools/core/mark-and-delete/entity-rows-registry.class');
